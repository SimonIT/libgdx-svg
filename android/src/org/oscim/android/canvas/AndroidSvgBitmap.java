...
public class AndroidSvgBitmap extends AndroidBitmap {
    ...
    public static Bitmap getResourceBitmap(InputStream inputStream, float scaleFactor, float defaultSize, int width, int height, int percent) throws IOException {
        try {
            ...
            Bitmap bitmap = Bitmap.createBitmap((int) Math.ceil(bitmapWidth),
    ...
    private static Bitmap getResourceBitmapImpl(InputStream inputStream, int width, int height, int percent) throws IOException {
